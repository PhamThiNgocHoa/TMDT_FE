...
export const FooterLogo = () => (
    <section>
        <div>
            <div className="max-w-full w-[118px]">
                <h2 className="pr-0 w-full text-2xl font-bold tracking-wider leading-none whitespace-nowrap text-neutral-50">
                    OrangeTech
                </h2>
                <h3 className="mt-6 text-xl font-medium leading-snug text-neutral-50">
                    Theo dõi
                </h3>
            </div>
            <p className="mt-6 text-base text-neutral-50">
                Giảm 10% cho đơn hàng đầu tiên của bạn
            </p>
        </div>
        <div className="flex gap-8 items-center py-3 pl-4 mt-4 max-w-full text-base rounded border-solid border-[1.5px] border-[color:var(--Text,#FAFAFA)] w-[243px] footer-email-input">
...
export const FooterSupport = () => (
    <section className="text-neutral-50 w-[175px]">
        <h3 className="text-xl font-medium leading-snug text-neutral-50">Hỗ trợ</h3>
        <address className="mt-6 max-w-full text-base w-[175px] not-italic">
            <p className="leading-6 text-neutral-50">
                111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.
            </p>
            <p className="mt-4 text-neutral-50">exclusive@gmail.com</p>
            <p className="mt-4 text-neutral-50">+88015-88888-9999</p>
        </address>
    </section>
);
...
export const FooterAccount = () => (
    <nav className="text-neutral-50">
        ...
        <ul className="mt-6 text-base space-y-10 ">
...
export const FooterQuickLinks = () => (
    <nav className="text-neutral-50">
        ...
        <ul className="mt-6 text-base">
            ...
            <li className="mt-4 text-neutral-50">Điều khoản sử dụng</li>
            <li className="mt-4 text-neutral-50">Câu hỏi thường gặp</li>
            <li className="mt-4 text-neutral-50">Liên hệ</li>
        </ul>
    </nav>
);
...
export const FooterDownloadApp = () => (
    <section className="flex flex-col">
        <div>
            ...
            <div className="flex flex-col mt-6">
                ...
                <div className="flex items-start gap-3 mt-2">
                    ...
                    {/* App buttons stacked vertically */}
                    <div className="flex flex-col justify-between h-full">
                        <img
                            ...
                            alt="Google Play"
                            className="w-[110px] aspect-[2.75] object-contain"
                        />
                        <img
                            ...
                            alt="App Store"
                            className="w-[110px] aspect-[2.75] object-contain mt-2"
                        />
                    </div>
                </div>
            </div>
        ...
        <div >
            ...
            />
            <div className="w-12 h-12" aria-label="Twitter" />
            <div className="w-12 h-12" aria-label="Instagram" />
            <img
...
export const FooterCopyright = () => (
    <div className="flex flex-col items-center mt-16 w-full max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex justify-center items-center mt-4 text-base text-white w-full">
            <div className="flex gap-1.5 items-center">
                {/* Icon placeholder */}
                <div className="w-5 h-5" />
                <p className="text-white opacity-40 text-base whitespace-nowrap">
