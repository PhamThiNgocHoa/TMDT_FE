...
// ** Thêm import cho RevenueManagement **
...
const HeaderFooterControl = () => {
    ...
    const adminPaths = ['/admin', '/loginAd', '/postManagement', '/management/category', '/management/customer', '/management/revenue'];
    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route path="/management/customerManagement/add" element={<AddCustomer />} />
                <Route path="/management/customerManagement/edit/:Id" element={<EditCustomer />} />

                {/* Thêm routes quản lý doanh thu */}
                    <Route path="/management/revenue" element={<RevenueManagement />} />
                <Route path="/management/revenueManagement/add" element={<AddRevenue />} />
                <Route path="/management/revenueManagement/edit/:id" element={<EditRevenue />} />
            </Routes>
