...
export function TopBar() {
  const { filters, setFilters, fetchCustomers } = useCustomers();
    ...
    <header className={styles.adminTopBar}>
      <div className={styles.inputType}>
        <div className={styles.input}>
          ...
          />
          <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/72bf2217ab642717dfeb75629ee9b97dda595b98?placeholderIfAbsent=true&apiKey=5520a4f102154e9f835ab126f337bb29"
