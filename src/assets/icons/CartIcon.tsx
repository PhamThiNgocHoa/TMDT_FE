...
export const CartIcon = () => (
    <svg width="42" height="43" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M8.5 21H20.1925C20.2792 21.0001 20.3633 20.9701 20.4304 20.9151C20.4975 20.8601 20.5434 20.7836 20.5605 20.6986L21.9105 13.9486C21.9214 13.8942 21.92 13.838 21.9066 13.7841C21.8931 13.7303 21.8679 13.6801 21.8327 13.6372C21.7975 13.5943 21.7532 13.5597 21.703 13.536C21.6528 13.5122 21.598 13.5 21.5425 13.5H7" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <circle cx="23" cy="10.5" r="8" fill="#DB4444"/>
        <text fill="#FAFAFA" xmlSpace="preserve" style={{whiteSpace: "pre"}} fontFamily="Poppins" fontSize="12" letterSpacing="0em">
            <tspan x="20.0488" y="14.7">2</tspan>
        </text>
    </svg>
);
